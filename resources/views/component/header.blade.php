              ...
              <?php } else if($loginRole == '1'){ ?>
                ...
                <?php } else if($loginRole == '2'){ ?>
                    ...
                    <li class="nav-item">
                        ...
                        <!-- Virtual Ballance -->
                        <li class="nav-item">
                            <a href="{{ route('virtual-balance') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('add-commission') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Commission</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('view-commission') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('consolidate-account-statement')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Consolidate statement</p>
                                    </a>
                                </li>                                
                                  <li class="nav-item">
                                    <a href="{{route('topup-credit-report')}}" class="nav-link">

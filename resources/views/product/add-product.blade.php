        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header bg-dark">
                    <h3 class="card-title text-white">Add Product Detail</h3>
...
<form action="{{route('save-product')}}" method="POST"  enctype='multipart/form-data'>
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="input-1" name="product_name" placeholder="Enter Product Name">
             @error('product_name')
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="input-1" name="product_code" placeholder="Enter Product code">
           </div>
           <div class="form-group col-md-6">
            <label for="input-1">Category</label>
            <input type="text" class="form-control" id="input-1" name="category" placeholder="Enter Product Category" required>
           </div>
           <div class="form-group col-md-6">
            <label for="input-1">Brand</label>
            <input type="text" class="form-control" id="input-1" name="brand" placeholder="Enter Brand Name" required>
           </div>
           ...
           <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="input-4" placeholder="Enter Product Quantity" name="available_quantity">
           </div>
           <div class="form-group col-md-12">
            <label for="input-4">Product Price</label>
            <input type="text" class="form-control" id="input-4" placeholder="Enter Product Price" name="price">
           </div>
           <div class="form-group col-md-12">

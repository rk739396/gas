...
class TopupController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data['company'] = DB::table('companies')->where('user_id', $distributorid)->get();
    ...
    public function view_topup(Request $request){
        ...
        if($loginRole == '2'){
            $data['topup'] = DB::table('topups')->where('distributor_id', $distributorid)->get();
        }
        else if($loginRole == '3'){
            $data['topup'] = DB::table('topups')->where('distributor_id', $distributorid)->get();
        }
        else if($loginRole == '5'){
            $data['topup'] = DB::table('topups')->where('distributor_id', $distributorid)->where('user_id',  $loginUser)->get();
        }
    ...
    public function create(Request $request)
    {
        ...
        return redirect(route('view-topup'))->with('status', 'Topup Added Successfully');
    }
